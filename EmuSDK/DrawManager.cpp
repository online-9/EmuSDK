...
void CRender::Init(IDirect3DDevice9* pDevice)
{
	...
	D3DXCreateFontA(this->device, 12, 0, FW_BOLD, 1, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY, DEFAULT_PITCH, "Tahoma", &this->fonts.esp);
	D3DXCreateFontA(this->device, 8, 0, FW_DONTCARE, 1, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY, DEFAULT_PITCH, "HaxrCorp S8", &this->fonts.esp_small);
