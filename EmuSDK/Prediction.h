...
public:
	void SetupMove(C_BaseEntity *player, CUserCmd *ucmd, IMoveHelper *moveHelper, void* pMoveData)
	{
		...
		return g_pUtils->Emulate<oSetupMove>(this, 20)(this, player, ucmd, moveHelper, pMoveData);
	}
	...
	void FinishMove(C_BaseEntity *player, CUserCmd *ucmd, void*pMoveData)
	{
		...
		return g_pUtils->Emulate<oFinishMove>(this, 21)(this, player, ucmd, pMoveData);
	}
